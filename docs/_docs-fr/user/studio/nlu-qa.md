...
![Interface d'admin NLP - QA](../../../assets/img/tock-nlp-admin-qa.png "Exemple de monitoring de pertinence")
...
![schéma Tock](../../../assets/img/intent-errors.png "Erreur d'intentions détectées")
...
![schéma Tock](../../../assets/img/entity-errors.png "Erreur d'entités détectées")
...
Rendez-vous dans [Menu _Settings_](configuration.md) pour la suite du manuel utilisateur. 

...
class AuthenticateBotConnectorServiceTest {
    ...
    private val authenticateBotConnectorService = AuthenticateBotConnectorService(CaseInsensitiveHeaders(), "fakeAppId", activity)
    ...
    private val openIdMetadataMockRequest = MockResponse()
    ...
    fun getOpenidMetadataDocumentDeserializeWell() {
        ...
        server.enqueue(openIdMetadataMockRequest)
    ...
    fun tokenMustBeValid() {
        ...
        val authenticateBotConnectorService = AuthenticateBotConnectorService(headers, "fakeAppId", activity)
    ...
    fun unauthorizedDueToMissingAuthorizationHeader() {
        ...
        assertFailsWith(ForbiddenException::class) {
            authenticateBotConnectorService.isTokenValid()
        }
    }
    ...
    fun unauthorizedDueToDifferentServiceUrl() {
        ...
        val headers: MultiMap = CaseInsensitiveHeaders().add("Authorization", bearerAuthorization )
        val authenticateBotConnectorService = AuthenticateBotConnectorService(headers, "fakeAppId", otherActivity)

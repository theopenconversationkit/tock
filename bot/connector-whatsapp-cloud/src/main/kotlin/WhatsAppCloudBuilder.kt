...
fun Bus<*>.whatsAppCloudImage(
    ...
    WhatsAppCloudBotImageMessage(
        image =
            WhatsAppCloudBotImage.LinkedImage(
                url = url,
...
fun Bus<*>.whatsAppCloudImage(
    ...
    WhatsAppCloudBotImageMessage(
        image =
            WhatsAppCloudBotImage.UploadedImage(
                id = id,
                bytes = imageBytes,
                mimeType = mimeType,
                caption = translate(caption).toString().checkLength(WHATSAPP_IMAGE_CAPTION_MAX_LENGTH),
...
): WhatsAppCloudBotInteractiveMessage = whatsAppCloudReplyButtonMessage(text, replies.toList(), header, footer)
...
fun I18nTranslator.whatsAppCloudReplyImgButtonMessage(
    ...
    vararg replies: QuickReply,
    footer: CharSequence? = null,
): WhatsAppCloudBotInteractiveMessage = whatsAppCloudReplyImgButtonMessage(imgUrl, text, replies.toList(), footer)
...
fun I18nTranslator.whatsAppCloudListMessage(
    ...
    header: CharSequence? = null,
    footer: CharSequence? = null,
): WhatsAppCloudBotInteractiveMessage = whatsAppCloudListMessage(text, button, replies.toList(), header, footer)
...
fun I18nTranslator.whatsAppCloudListMessage(
    ...
    header: CharSequence? = null,
    footer: CharSequence? = null,
): WhatsAppCloudBotInteractiveMessage = whatsAppCloudListMessage(text, button, sections.toList(), header, footer)
            ...
            WhatsAppCloudBotInteractive(
                ...
                action =
                    WhatsAppCloudBotAction(
                        ...
                        sections =
                            sections.checkCount(WHATSAPP_MAX_SECTIONS) { count ->
 ...
 * @see whatsAppCloudQuickReply
 */
fun I18nTranslator.whatsAppCloudListSection(
    title: CharSequence,
    vararg rows: QuickReply,
) = whatsAppCloudListSection(title, listOf(*rows))
 ...
 * - [text] is limited to 1024 characters
 */
fun I18nTranslator.whatsAppCloudReplyLocationMessage(text: CharSequence): WhatsAppCloudBotInteractiveMessage =
    WhatsAppCloudBotInteractiveMessage(
        recipientType = WhatsAppCloudBotRecipientType.individual,
        interactive =
            WhatsAppCloudBotInteractive(
...
): QuickReply = whatsAppCloudQuickReply(title, targetIntent, stepName, parameters.toMap())
...
fun <T : Bus<T>> T.whatsAppCloudBodyTemplate(parameters: List<TextParameter>) = whatsAppCloudTemplateBody(parameters)
 ...
 */
fun <T : Bus<T>> T.whatsAppCloudTemplateBody(parameters: List<TextParameter>): WhatsappTemplateComponent.Body =
    WhatsappTemplateComponent.Body(
...
fun <T : Bus<T>> T.whatsAppCloudTextParameterTemplate(buttonTitle: CharSequence?): TextParameter =
    TextParameter(
...
): WhatsappTemplateComponent.Button =
    WhatsappTemplateComponent.Button(
...
fun whatsAppCloudTemplateImageHeader(imageId: String): WhatsappTemplateComponent.Header =
    WhatsappTemplateComponent.Header(

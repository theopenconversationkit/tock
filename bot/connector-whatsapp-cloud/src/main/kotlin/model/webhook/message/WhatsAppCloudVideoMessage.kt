...
import ai.tock.bot.connector.whatsapp.cloud.model.webhook.message.content.VideoContent

data class WhatsAppCloudVideoMessage(
...
) : WhatsAppCloudMessage(WhatsAppCloudMessageType.video)

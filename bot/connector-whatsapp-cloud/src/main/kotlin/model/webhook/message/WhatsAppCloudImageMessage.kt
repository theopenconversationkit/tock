...
import ai.tock.bot.connector.whatsapp.cloud.model.webhook.message.content.ImageContent
import ai.tock.bot.connector.whatsapp.cloud.model.webhook.message.content.Referral

data class WhatsAppCloudImageMessage(
...
) : WhatsAppCloudMessage(WhatsAppCloudMessageType.image)

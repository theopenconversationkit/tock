...
import ai.tock.bot.connector.whatsapp.cloud.model.webhook.message.content.SystemContent

data class WhatsAppCloudSystemMessage(
    val text: SystemContent,
...
) : WhatsAppCloudMessage(WhatsAppCloudMessageType.system)

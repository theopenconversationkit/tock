...
class ScenarioVersionServiceTest {
    ...
    private val scenarioVersion1 = ScenarioVersion(_id = versionId1, scenarioGroupId = groupId1, data = "DATA1",
        state = ScenarioVersionState.DRAFT, comment = "v1", creationDate = dateNow, updateDate = dateNow)
    private val scenarioVersion2 = ScenarioVersion(_id = versionId2, scenarioGroupId = groupId1, data = "DATA2",
        state = ScenarioVersionState.DRAFT, comment = "v2", creationDate = dateNow, updateDate = dateNow)
    private val scenarioVersion3 = ScenarioVersion(_id = versionId3, scenarioGroupId = groupId2, data = "DATA3",
    ...
    @Test fun `createMany WHEN creating many THEN return created scenario versions` () {
        // GIVEN
    ...
    @Test fun `createOne WHEN creating one THEN return created scenario version` () {
        // GIVEN
    ...
    @Test fun `findAllByScenarioGroupIdAndState WHEN 2 scenario draft versions exists THEN return 2 scenario versions` () {
        // GIVEN
    ...
    @Test fun `findOneById WHEN id exists in database THEN returns scenario version` () {
        // GIVEN
    ...
    @Test fun `countByScenarioGroupId WHEN 2 scenario versions matching the group id exists THEN count 3` () {
        // GIVEN
    ...
    @Test fun `updateOne WHEN id exists in database THEN update a scenario version` () {
        // GIVEN
    ...
    @Test fun `updateOne WHEN id does not exists in database THEN throw exception` () {
        // GIVEN
    ...
    @Test fun `deleteAllByScenarioGroupId WHEN scenario versions matching the group id exist in the database THEN delete those scenario versions` () {
        // GIVEN
    ...
    @Test fun `deleteAllByScenarioGroupId WHEN scenario versions matching the group id do not exist in the database THEN throw exception` () {
        // GIVEN
    ...
    @Test fun `deleteOneById WHEN id exists in database THEN delete a scenario version` () {
        // GIVEN

...
//    companion object {
//
//        val scenarioGroupDAO: ScenarioGroupDAO = mockk(relaxed = true)
//
//        init {
...
//        //GIVEN
//        every { scenarioGroupDAO.findAll() } returns listOf(createScenario(ID1, draft(VERSION1)))
//
//        //WHEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findAll() } returns listOf(createScenario(null, draft(null)))
//
//        //WHEN //THEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findAll() } returns listOf(
...
//        every { scenarioGroupDAO.findByVersion(VERSION1) } returns scenario
//
//        //WHEN
...
//        every { scenarioGroupDAO.findByVersion(VERSION1) } returns scenarioFound
//
//        //WHEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findByVersion(VERSION1) } returns createScenario(null)
//
//        //WHEN //THEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findByVersion(VERSION1) } returns null
//
//        //WHEN //THEN
...
//        //GIVEN
//        val scenario = createScenario(ID1, draft(VERSION1))
//        every { scenarioGroupDAO.findById(VERSION1) } returns scenario
//
//        //WHEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findById(VERSION1) } returns createScenario(null)
//
//        //WHEN //THEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findById(VERSION1) } returns null
//
//        //WHEN //THEN
...
//        every { scenarioGroupDAO.findById(ID1) } returns scenario
//
//        //WHEN
...
//        val scenarioFound = createScenario(ID1, draft(VERSION1), current(VERSION2))
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//
//        //WHEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findById(ID1) } returns createScenario(null)
//
//        //WHEN //THEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findById(ID1) } returns null
//
//        //WHEN //THEN
...
//        every { scenarioGroupDAO.create(scenarioToCreate) } returns scenarioCreated
//
//        //WHEN
...
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.patch(scenarioToCreate) } returns scenarioCreated
//
//        //WHEN
//        val scenario = scenarioService.create(scenarioRequest)
//
...
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.create(scenarioCreated) } returns scenarioCreated
//
//        //WHEN //THEN
...
//        val scenarioFound: Scenario = createScenario(ID1)
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.create(scenarioCreated) } returns null
//
//        //WHEN //THEN
...
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.update(scenarioUpdated) } returns scenarioUpdated
//
//        //WHEN
...
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.update(scenarioUpdated) } returns scenarioUpdated // List of version can be inverted so don't check parameter
//
...
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.update(scenarioToUpdate) } returns scenarioUpdated
//
//        //WHEN //THEN
...
//        val scenarioFound: Scenario = createScenario(ID1, draft(VERSION1, datePrevious))
//        every { scenarioGroupDAO.findById(ID1) } returns scenarioFound
//        every { scenarioGroupDAO.update(any()) } returns null
//
//        //WHEN //THEN
...
//
//        //THEN
//        verify(exactly = 1) { scenarioGroupDAO.delete(any()) }
//    }
//
//    @Test
//    fun `deleteById GIVEN id of scenario don't exist THEN nothing`() {
//        //GIVEN
//        every { scenarioGroupDAO.delete(ID2) } throws ScenarioNotFoundException(ID2, "test_not_found")
//
//        //WHEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findByVersion(VERSION1) } returns createScenario(ID1, draft(VERSION1))
//
//        //WHEN
...
//        //GIVEN
//        every { scenarioGroupDAO.findByVersion(VERSION1) } returns createScenario(ID1, draft(VERSION1), draft(VERSION2))
//
//        //WHEN
//        assertDoesNotThrow { scenarioService.deleteByVersion(VERSION1) }
//
//        //THEN
//        verify(exactly = 1) { scenarioGroupDAO.update(createScenario(ID1, draft(VERSION2))) }
//    }
//
//    @Test
//    fun `deleteByVersion GIVEN version of scenario doesn't exist THEN nothing`() {
//        //GIVEN
//        every { scenarioGroupDAO.findByVersion(VERSION2) } throws ScenarioNotFoundException(VERSION1, "test_not_found")
//
//        //WHEN
//        assertDoesNotThrow { scenarioService.deleteByVersion(VERSION2) }
//
//        //THEN
//        verify(exactly = 0) { scenarioGroupDAO.delete(any()) }
//    }
}
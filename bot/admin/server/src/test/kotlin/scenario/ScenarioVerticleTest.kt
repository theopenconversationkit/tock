...
//
//        //WHEN
//        val scenarioResult: ScenarioResult = createScenarioGroup.invoke(routingContext, scenarioRequest)
//
//        //THEN
//        assertEquals(createScenarioResult(ID1, VERSION1, DRAFT), scenarioResult)
//    }
...
//            createScenarioGroup.invoke(routingContext, createScenarioRequest(null))
//        }
...
//
//        //WHEN
//        val scenarioResult: ScenarioResult = updateScenarioVersion.invoke(routingContext, scenarioRequest)
//
//        //THEN
//        assertEquals(createScenarioResult(ID1, VERSION1, DRAFT), scenarioResult)
//    }
...
//        //WHEN THEN
//        val exceptionThrown = assertThrows<InternalServerException> {
//            updateScenarioVersion.invoke(routingContext, scenarioRequest)
//        }
//        assertEquals("scenario must have saga id but is null", exceptionThrown.message)
//    }
//
...
//
//        //WHEN THEN
//        val exceptionThrown = assertThrows<NotFoundException> { updateScenarioVersion.invoke(routingContext, scenarioRequest) }
//        assertEquals("scenarioID uri parameter not found", exceptionThrown.message)
//    }
//
//    @Test
...
//        //WHEN THEN
//        val exceptionThrown = assertThrows<InternalServerException> {
//            updateScenarioVersion.invoke(routingContext, createScenarioRequest(ID1))
//        }
//        assertEquals(testExceptionMessage, exceptionThrown.message)
//    }
//
...
//
//        //WHEN
//        deleteScenarioGroup.invoke(routingContext)
//
...
//
//        //WHEN THEN
//        val exceptionThrown = assertThrows<NotFoundException> { deleteScenarioGroup.invoke(routingContext) }

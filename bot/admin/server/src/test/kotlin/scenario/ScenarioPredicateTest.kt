...
//        val scenario = createScenario(ID1, draft(VERSION1))
//        val versions: Map<String, ScenarioVersionState> = scenario.extractVersionsAndCheckIsNotEmpty()
...
//        val stateByVersions: Map<String, ScenarioVersionState> = scenario.extractVersionsAndCheckIsNotEmpty()
...
//        val beforeUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to DRAFT)
//        val afterUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to DRAFT)
...
//        val beforeUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to DRAFT)
//        val afterUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to CURRENT)
//        assertDoesNotThrow { beforeUpdate.checkUpdateStateIsValidTo(afterUpdate) }
//    }
//
//    @Test
...
//        val beforeUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to DRAFT)
//        val afterUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to ARCHIVED)
//        assertDoesNotThrow { beforeUpdate.checkUpdateStateIsValidTo(afterUpdate) }
//    }
//
//    @Test
//    fun `GIVEN current to draft WHEN checkUpdateStateIsValideTo THEN exception is thrown`() {
//        val beforeUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to CURRENT)
//        val afterUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to DRAFT)
...
//        val beforeUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to ARCHIVED)
//        val afterUpdate: Map<String, ScenarioVersionState> = mapOf(VERSION1 to DRAFT)

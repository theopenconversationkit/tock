 ...
 */
object ScenarioServiceImpl : ScenarioService {
    ...
    override fun findAllScenarioGroupWithVersionsByBotId(namespace: String, botId: String): List<ScenarioGroup> {
        ...
        val scenarioGroups = ScenarioGroupServiceImpl.findAllByBotId(botId)
    ...
    override fun findOneScenarioGroup(namespace: String, scenarioGroupId: String): ScenarioGroup {
        // Get scenario group from DB
        val scenarioGroup = ScenarioGroupServiceImpl.findOneById(scenarioGroupId)
    ...
    override fun findOneScenarioVersion(scenarioGroupId:String, scenarioVersionId: String): ScenarioVersion {
        ...
        val scenarioVersion = ScenarioVersionServiceImpl.findOneById(scenarioVersionId)
    ...
    override fun createOneScenarioGroup(scenarioGroup: ScenarioGroup): ScenarioGroup {
        ...
        val scenarioGroup = ScenarioGroupServiceImpl.createOne(scenarioGroup)
        // Init the first draft version
        val scenarioVersion = ScenarioVersionServiceImpl.createOne(initDraftScenarioVersion(scenarioGroup._id))
    ...
    override fun importOneScenarioGroup(scenarioGroup: ScenarioGroup): ScenarioGroup {
        ...
        val scenarioGroup = ScenarioGroupServiceImpl.createOne(scenarioGroup)
        // Create versions
        val scenarioVersions = ScenarioVersionServiceImpl.createMany(scenarioGroup.versions)
    ...
    override fun importManyScenarioVersion(namespace: String, scenarioVersions: List<ScenarioVersion>): List<ScenarioVersion> {
        ...
        // Create versions
        return ScenarioVersionServiceImpl.createMany(scenarioVersions)
    }
    ...
    override fun createOneScenarioVersion(namespace: String, scenarioVersion: ScenarioVersion): ScenarioVersion {
        ...
        return ScenarioVersionServiceImpl.createOne(scenarioVersion)
    }

    override fun updateOneScenarioGroup(namespace: String, scenarioGroup: ScenarioGroup): ScenarioGroup {
        val updatedScenarioGroup = ScenarioGroupServiceImpl.updateOne(scenarioGroup)

        scenarioGroup.enabled?.let {
            StoryServiceImpl.updateActivateStoryFeatureByNamespaceAndBotIdAndStoryId(
                namespace,
                scenarioGroup.botId,
    ...
    override fun updateOneScenarioVersion(scenarioVersion: ScenarioVersion): ScenarioVersion {
        val scenarioVersionDB = ScenarioVersionServiceImpl.findOneById(scenarioVersion._id.toString())
        ...
        if(scenarioVersion.isCurrent()){
            ...
            val scenarioVersionCurrentDB = ScenarioVersionServiceImpl
            ...
            scenarioVersionCurrentDB?.let {
                ...
                ScenarioVersionServiceImpl.updateOne(scenarioVersionCurrentDB.copy(state = ARCHIVED))
        ...
        val scenarioVersionUpdated = ScenarioVersionServiceImpl.updateOne(scenarioVersion)
    ...
    override fun deleteOneScenarioGroup(namespace: String, botId: String, scenarioGroupId: String): Boolean {
        return try {
            ...
            // Delete all versions
            ScenarioVersionServiceImpl.deleteAllByScenarioGroupId(scenarioGroupId)
            ...
            ScenarioGroupServiceImpl.deleteOneById(scenarioGroupId)
    ...
    override fun deleteOneScenarioVersion(
        ...
        return try {
            val scenarioVersionDB = ScenarioVersionServiceImpl.findOneById(scenarioVersionId)
            ...
            ScenarioVersionServiceImpl.deleteOneById(scenarioVersionId)
    ...
    private fun deleteTickStory(namespace: String, botId: String, scenarioGroupId: String) {
        StoryServiceImpl.deleteStoryByNamespaceAndBotIdAndStoryId(namespace, botId, scenarioGroupId)
    ...
    private fun deleteEmptyScenarioGroup(scenarioGroupId: String) {
        if (ScenarioVersionServiceImpl.countAllByScenarioGroupId(scenarioGroupId) == 0L) {
            ScenarioGroupServiceImpl.deleteOneById(scenarioGroupId)

...
object VectorStoreService {
    ...
    fun deleteConfig(
        ...
        val vectorStoreConfig =
            vectorStoreConfigurationDAO.findByNamespaceAndBotId(namespace, botId)
     ...
     */
    private fun saveVectorStoreConfiguration(vectorStoreConfiguration: BotVectorStoreConfigurationDTO): BotVectorStoreConfiguration {

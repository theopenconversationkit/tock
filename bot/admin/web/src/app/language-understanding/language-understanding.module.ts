...
import { NbButtonModule, NbIconModule, NbRouteTabsetModule, NbTabsetModule } from '@nebular/theme';
...
@NgModule({
  declarations: [LanguageUnderstandingTabsComponent, SentencesInboxComponent, SentencesSearchComponent, SentencesUnknownComponent],
  imports: [
    CommonModule,

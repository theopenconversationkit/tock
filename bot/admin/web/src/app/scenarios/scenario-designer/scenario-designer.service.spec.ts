...
import { ScenarioDesignerService, SCENARIO_STEPS_ERRORS } from './scenario-designer.service';
...
describe('ScenarioDesignerService', () => {
  ...
  it('should detect step validity', () => {
    ...
    let res = service.isStepValid(scenarioCopy, SCENARIO_MODE.casting);
    ...
    res = service.isStepValid(scenarioCopy, SCENARIO_MODE.casting);
    expected = {
      valid: false,
    ...
    res = service.isStepValid(scenarioCopy, SCENARIO_MODE.production);
    expected = {
      valid: false,
    ...
    res = service.isStepValid(scenarioCopy, SCENARIO_MODE.publishing);
    expected = {
      valid: false,

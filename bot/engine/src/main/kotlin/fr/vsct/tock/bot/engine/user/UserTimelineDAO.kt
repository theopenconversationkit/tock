...
interface UserTimelineDAO {
    ...
    /**
     * Returns all dialogs updated from to the specified Instants.
     */
    fun getDialogsUpdatedFromTo(from: Instant,to : Instant, storyDefinitionProvider: (String) -> StoryDefinition): List<Dialog>
}

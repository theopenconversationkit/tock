...
/**
 * To specify [ConnectorStoryHandler] for Twitter connector.
 ...
 */
@ConnectorHandler(connectorTypeId = TWITTER_CONNECTOR_TYPE_ID)
@Target(AnnotationTarget.CLASS)
@MustBeDocumented
annotation class TwitterHandler(val value: KClass<out ConnectorStoryHandler<*>>)

...
internal class DialogFlowStateTransitionStatUserAggregationCol_Deserializer :
        JsonDeserializer<DialogFlowStateTransitionStatUserAggregationCol>(),
        JacksonModuleServiceLoader {
    override fun module() =
            SimpleModule().addDeserializer(DialogFlowStateTransitionStatUserAggregationCol::class.java,
            this)

    override fun deserialize(p: JsonParser, ctxt: DeserializationContext):
            DialogFlowStateTransitionStatUserAggregationCol {
        with(p) {
            ...
            return if(_applicationId_set && _date_set && _count_set)
                    DialogFlowStateTransitionStatUserAggregationCol(applicationId =
                            _applicationId_!!, date = _date_!!, count = _count_!!)
                    else {
    ...
    companion object {
        private val primaryConstructor: KFunction<DialogFlowStateTransitionStatUserAggregationCol>
                by lazy(LazyThreadSafetyMode.PUBLICATION) {
                DialogFlowStateTransitionStatUserAggregationCol::class.primaryConstructor!! }

...
private val __OriginaLocale: KProperty1<UserTimelineCol.UserPreferencesWrapper, Locale?>
    get() = UserTimelineCol.UserPreferencesWrapper::originaLocale
...
internal class UserPreferencesWrapper_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val originaLocale: KPropertyPath<T, Locale?>
        get() = KPropertyPath(this,__OriginaLocale)
    ...
    companion object {
        ...
        val Gender: KProperty1<UserTimelineCol.UserPreferencesWrapper, String?>
            get() = __Gender
        val OriginaLocale: KProperty1<UserTimelineCol.UserPreferencesWrapper, Locale?>
            get() = __OriginaLocale

...
internal class UserPreferencesWrapper_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, UserTimelineCol.UserPreferencesWrapper?>) : KPropertyPath<T, UserTimelineCol.UserPreferencesWrapper?>(previous,property) {
    val firstName: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol.UserPreferencesWrapper::firstName)

    val lastName: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol.UserPreferencesWrapper::lastName)

    val email: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol.UserPreferencesWrapper::email)

    val timezone: KPropertyPath<T, ZoneId?>
        get() = org.litote.kmongo.property.KPropertyPath<T, java.time.ZoneId?>(this,UserTimelineCol.UserPreferencesWrapper::timezone)

    val locale: KPropertyPath<T, Locale?>
        get() = org.litote.kmongo.property.KPropertyPath<T, java.util.Locale?>(this,UserTimelineCol.UserPreferencesWrapper::locale)

    val picture: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol.UserPreferencesWrapper::picture)

    val gender: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol.UserPreferencesWrapper::gender)

    val test: KPropertyPath<T, Boolean?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.Boolean?>(this,UserTimelineCol.UserPreferencesWrapper::test)

    val encrypted: KPropertyPath<T, Boolean?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.Boolean?>(this,UserTimelineCol.UserPreferencesWrapper::encrypted)
    companion object {
...
internal class UserPreferencesWrapper_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, UserTimelineCol.UserPreferencesWrapper>?>) : KMapPropertyPath<T, K, UserTimelineCol.UserPreferencesWrapper?, UserPreferencesWrapper_<T>>(previous,property) {
    val firstName: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol.UserPreferencesWrapper::firstName)

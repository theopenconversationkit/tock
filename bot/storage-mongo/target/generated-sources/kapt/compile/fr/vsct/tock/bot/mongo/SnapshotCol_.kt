...
internal class SnapshotCol_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val _id: KPropertyPath<T, Id<Dialog>?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                org.litote.kmongo.Id<fr.vsct.tock.bot.engine.dialog.Dialog>?>(this,SnapshotCol::_id)

    val snapshots: KCollectionSimplePropertyPath<T, Snapshot?>
        get() = org.litote.kmongo.property.KCollectionSimplePropertyPath<T,
                fr.vsct.tock.bot.engine.dialog.Snapshot?>(this,SnapshotCol::snapshots)

    val lastUpdateDate: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Instant?>(this,SnapshotCol::lastUpdateDate)

...
internal class UserTimelineCol_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, UserTimelineCol?>) : KPropertyPath<T, UserTimelineCol?>(previous,property) {
    val _id: KPropertyPath<T, Id<UserTimelineCol>?>
        get() = org.litote.kmongo.property.KPropertyPath<T, org.litote.kmongo.Id<fr.vsct.tock.bot.mongo.UserTimelineCol>?>(this,UserTimelineCol::_id)
    ...
    val temporaryIds: KCollectionSimplePropertyPath<T, String?>
        get() = org.litote.kmongo.property.KCollectionSimplePropertyPath<T, kotlin.String?>(this,UserTimelineCol::temporaryIds)

    val applicationIds: KCollectionSimplePropertyPath<T, String?>
        get() = org.litote.kmongo.property.KCollectionSimplePropertyPath<T, kotlin.String?>(this,UserTimelineCol::applicationIds)

    val lastActionText: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,UserTimelineCol::lastActionText)

    val lastUpdateDate: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T, java.time.Instant?>(this,UserTimelineCol::lastUpdateDate)

    val lastUserActionDate: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T, java.time.Instant?>(this,UserTimelineCol::lastUserActionDate)
    companion object {
...
internal class UserTimelineCol_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, UserTimelineCol>?>) : KMapPropertyPath<T, K, UserTimelineCol?, UserTimelineCol_<T>>(previous,property) {
    val _id: KPropertyPath<T, Id<UserTimelineCol>?>
        get() = org.litote.kmongo.property.KPropertyPath<T, org.litote.kmongo.Id<fr.vsct.tock.bot.mongo.UserTimelineCol>?>(this,UserTimelineCol::_id)

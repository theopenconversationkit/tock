...
internal class StoryMongoWrapper_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val storyDefinitionId: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.String?>(this,DialogCol.StoryMongoWrapper::storyDefinitionId)
    ...
    val currentStep: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.String?>(this,DialogCol.StoryMongoWrapper::currentStep)
    ...
    companion object {
        ...
        val CurrentIntent: Intent_<DialogCol.StoryMongoWrapper>
            get() =
                    Intent_<DialogCol.StoryMongoWrapper>(null,DialogCol.StoryMongoWrapper::currentIntent)
        ...
        val Actions: ActionMongoWrapper_Col<DialogCol.StoryMongoWrapper>
            get() =
                    ActionMongoWrapper_Col<DialogCol.StoryMongoWrapper>(null,DialogCol.StoryMongoWrapper::actions)}
}

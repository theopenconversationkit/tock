...
internal class DialogTextCol_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, DialogTextCol?>) : KPropertyPath<T, DialogTextCol?>(previous,property) {
    val text: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,DialogTextCol::text)

    val dialogId: KPropertyPath<T, Id<Dialog>?>
        get() = org.litote.kmongo.property.KPropertyPath<T, org.litote.kmongo.Id<fr.vsct.tock.bot.engine.dialog.Dialog>?>(this,DialogTextCol::dialogId)

    val date: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T, java.time.Instant?>(this,DialogTextCol::date)
    companion object {
...
internal class DialogTextCol_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, DialogTextCol>?>) : KMapPropertyPath<T, K, DialogTextCol?, DialogTextCol_<T>>(previous,property) {
    val text: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,DialogTextCol::text)

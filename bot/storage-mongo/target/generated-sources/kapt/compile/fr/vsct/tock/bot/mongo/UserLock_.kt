...
internal class UserLock_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val _id: KPropertyPath<T, Id<MongoUserLock.UserLock>?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                org.litote.kmongo.Id<fr.vsct.tock.bot.mongo.MongoUserLock.UserLock>?>(this,MongoUserLock.UserLock::_id)

    val locked: KPropertyPath<T, Boolean?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.Boolean?>(this,MongoUserLock.UserLock::locked)

    val date: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Instant?>(this,MongoUserLock.UserLock::date)

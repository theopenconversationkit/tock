...
internal class UserStateWrapper_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val creationDate: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Instant?>(this,UserTimelineCol.UserStateWrapper::creationDate)

    val lastUpdateDate: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Instant?>(this,UserTimelineCol.UserStateWrapper::lastUpdateDate)
    ...
    val flags: KMapSimplePropertyPath<T, String?, UserTimelineCol.TimeBoxedFlagWrapper?>
        get() = org.litote.kmongo.property.KMapSimplePropertyPath<T, kotlin.String?,
                fr.vsct.tock.bot.mongo.UserTimelineCol.TimeBoxedFlagWrapper?>(this,UserTimelineCol.UserStateWrapper::flags)

...
object DataMigrationMetricMongoDAO {
     ...
     */
    fun countEligibleIndicators(): Long =
        indicatorCol.countDocuments(
                    ...
                    Projections.computed(
                        ...
                        Document(
                            ...
                            listOf(
                                Document(
                                    "\$arrayElemAt",
                                    listOf("\$dialogs.stories.actions.applicationId", 0),
                                ),
                                0,
                            ),
                        ),
    ...
    fun updateMetricByProjections(metricProjections: List<MetricProjectionResult>): Long {
        ...
        val updates =
            metricProjections.map { projection ->

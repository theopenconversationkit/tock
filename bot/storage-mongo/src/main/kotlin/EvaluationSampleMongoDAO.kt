...
internal object EvaluationSampleMongoDAO : EvaluationSampleDAO {
    ...
    override fun deleteByNamespaceAndBotId(
        ...
        val samples = col.find(and(EvaluationSample::namespace eq namespace, EvaluationSample::botId eq botId)).toList()
        samples.forEach { sample ->
            EvaluationMongoDAO.deleteByEvaluationSampleId(sample._id)
        }
        return col.deleteMany(and(EvaluationSample::namespace eq namespace, EvaluationSample::botId eq botId)).deletedCount
    }
}

...
package ai.tock.llm.orchestrator.client.retrofit
...
object GenAIOrchestratorClient {
    private val baseUrl: String = property("tock_llm_orchestrator_server_url", "http://localhost:8000")
    private val timeout: Long = longProperty("tock_llm_orchestrator_client_request_timeout_ms", 55000)

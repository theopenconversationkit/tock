...
internal class KeycloakOAuth2Provider(
        ...
        private val oauth2: OAuth2Auth = OAuth2Auth.create(
                ...
                .setClientId(
                        property("tock_keycloak_client_id", "tock")
                )
                .setClientSecret(
                        property("tock_keycloak_secret_key", "thesecretkeyfromkeycloak")
                )
                .setSite(
                        property("tock_keycloak_site_url", "https://keycloak/realms/myrealm")
                )
                .setTokenPath(
                        property("tock_keycloak_access_token_path", "/protocol/openid-connect/token")
                )
                .setAuthorizationPath(
                        property("tock_keycloak_authorize_path", "/protocol/openid-connect/auth")
                )
                .setUserInfoPath(
                        property("tock_keycloak_userinfo_path", "/protocol/openid-connect/userinfo")
                )
                .apply {

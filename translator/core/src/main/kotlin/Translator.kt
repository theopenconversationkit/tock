...
object Translator {
     ...
     */
    private fun checkDefaultConsistency(
        key: I18nLabelValue,
        value: I18nLabel,
    ): Boolean {
    ...
    ): I18nLabel = saveIfNotExist(value, defaultLocale, readOnly)
        ...
        return with(localized) {
            if (alternatives.isEmpty()) {
                ...
                if (i > alternatives.size) {
                    ...
                    val newIndex =
                        if (alreadyUsedIndexes.size > alternatives.size) {

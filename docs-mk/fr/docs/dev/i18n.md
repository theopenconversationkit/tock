...
La page [Bot multilingue](../user/i18n.md) de la documentation utilisateur présente les bases de l'internationalisation
...
Pour activer l'internationalisation dans Tock, programmatiquement ou pas, voir [Bot multilingue](../user/i18n.md).
...
Voir [Bot multilingue](../user/i18n.md).

...
class ChunkInfos(BaseModel):
    ...
    chunk: Optional[str] = Field(
        description="Unique identifier of the chunk.", examples=["cd6d8221-ba9f-44da-86ee-0e25a3c9a5c7"], default=None
    )
    sentences: Optional[List[str]] = Field(
        description="List of verbatim sentences from the chunk that were used by the LLM.", default=None
    )
    reason: Optional[str] = Field(
        description="Reason why the chunk was not used (e.g., irrelevant, general background).", default=None
    )
...
class LLMAnswer(BaseModel):
    ...
    answer: Optional[str] = Field(
        description="The textual answer generated by the LLM, in the user's locale.", default=None
    )
    ...
    suggested_topics: Optional[List[str]] = Field(
        description="A list of suggested alternative or related topics, " "used when the main topic is 'unknown'.",
        default=None,
    )
...
class ChatMessage(BaseModel):
    ...
    text: str = Field(description="Conversation message text", examples=["Hello, how can I do this?"])
...
class RAGDocumentMetadata(BaseModel):
    ...
    index_session_id: str = Field(description="The indexing session id.", examples=["123f-ed01-gt21-gg08"])
...
class QADebugData(BaseModel):
    ...
    documents: List[RAGDocument] = Field(description="Documents retrieved from the vector store.")
    ...
    duration: float = Field(description="The duration of RAG in seconds.", examples=["7.2"])

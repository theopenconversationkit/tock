...
#
"""Model for creating AwsBedrockEMSetting."""
...
class AwsBedrockEMSetting(BaseEMSetting):
    """
    A class for AWS Bedrock Embedding Model Setting.
    ...
    provider: Literal[EMProvider.AWS_BEDROCK] = Field(
        description='The Embedding Model Provider.',
        examples=[EMProvider.AWS_BEDROCK],
    )
    model: str = Field(
        description='The Bedrock embedding model id',

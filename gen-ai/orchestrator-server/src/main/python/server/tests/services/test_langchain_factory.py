...
def test_get_HuggingFaceTGI_llm_factory():
    huggingface = get_llm_factory(
    ...
    assert huggingface.setting.provider == LLMProvider.HUGGING_FACE_TGI
    assert isinstance(huggingface, HuggingFaceTGILLMFactory)

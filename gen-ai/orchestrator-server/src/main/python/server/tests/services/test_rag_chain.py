...
@patch(
    'gen_ai_orchestrator.services.langchain.factories.langchain_factory.get_compressor_factory'
)
@patch(
...
@patch(
    'gen_ai_orchestrator.services.langchain.impls.guardrail.bloomz_guardrail.requests.post'
)

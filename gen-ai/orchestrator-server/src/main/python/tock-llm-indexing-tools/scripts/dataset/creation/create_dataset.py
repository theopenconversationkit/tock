...
def extract_dataset_items(template_file_path: str) -> list[DatasetItemInfo]:
    dataset_items = []
    input_df = pd.read_excel(template_file_path, sheet_name='Template_Suivi_Recette', header=None)
...
def send_to_langfuse(logger, input_config: CreateDatasetInput, dataset_items: list[DatasetItemInfo]) -> list[DatasetItem]:
    ...
    for item in dataset_items:
        ...
        items.append(client.create_dataset_item(

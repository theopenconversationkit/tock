...
mvn deploy -DskipTests=true -Dtravis --settings etc/deploy-settings.xml
#mvn dokka:javadocJar deploy -DskipTests=true -Dtravis --settings etc/deploy-settings.xml
fi
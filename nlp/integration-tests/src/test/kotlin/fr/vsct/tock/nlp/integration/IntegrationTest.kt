...
import fr.vsct.tock.nlp.front.client.FrontClient.parse
...
class IntegrationTest {
    ...
    fun testOpenNlpSimpleRequest() {
        val result = Parser.parse(QueryDescription(listOf("I want to go to Paris tomorrow"), "vsc", "test", QueryContext(Locale.ENGLISH, "clientTest", engineType = opennlp)))
        println(result)

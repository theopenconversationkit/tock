...
class IntentDefinition_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, IntentDefinition?>) : KPropertyPath<T, IntentDefinition?>(previous,property) {
    val name_: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,IntentDefinition::name)

    val namespace: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,IntentDefinition::namespace)

    val applications: KCollectionSimplePropertyPath<T, Id<ApplicationDefinition>?>
        get() = org.litote.kmongo.property.KCollectionSimplePropertyPath<T, org.litote.kmongo.Id<fr.vsct.tock.nlp.front.shared.config.ApplicationDefinition>?>(this,IntentDefinition::applications)
    ...
    val entitiesRegexp: KMapSimplePropertyPath<T, Locale?, LinkedHashSet<EntitiesRegexp>?>
        get() = org.litote.kmongo.property.KMapSimplePropertyPath<T, java.util.Locale?, java.util.LinkedHashSet<fr.vsct.tock.nlp.core.EntitiesRegexp>?>(this,IntentDefinition::entitiesRegexp)

    val mandatoryStates: KCollectionSimplePropertyPath<T, String?>
        get() = org.litote.kmongo.property.KCollectionSimplePropertyPath<T, kotlin.String?>(this,IntentDefinition::mandatoryStates)
    ...
    companion object {
        ...
        val Applications: KCollectionSimplePropertyPath<IntentDefinition, Id<ApplicationDefinition>?>
        ...
        val EntitiesRegexp: KMapSimplePropertyPath<IntentDefinition, Locale?, LinkedHashSet<EntitiesRegexp>?>
...
class IntentDefinition_Map<T, K>(previous: KPropertyPath<T, *>?, property: KProperty1<*, Map<K, IntentDefinition>?>) : KMapPropertyPath<T, K, IntentDefinition?, IntentDefinition_<T>>(previous,property) {
    val name_: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T, kotlin.String?>(this,IntentDefinition::name)

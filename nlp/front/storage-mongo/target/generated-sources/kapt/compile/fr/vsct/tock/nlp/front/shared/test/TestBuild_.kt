...
class TestBuild_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*, TestBuild?>) :
    ...
    val applicationId: KPropertyPath<T, Id<ApplicationDefinition>?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                org.litote.kmongo.Id<fr.vsct.tock.nlp.front.shared.config.ApplicationDefinition>?>(this,TestBuild::applicationId)

    val language: KPropertyPath<T, Locale?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.util.Locale?>(this,TestBuild::language)

    val startDate: KPropertyPath<T, Instant?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Instant?>(this,TestBuild::startDate)

    val buildModelDuration: KPropertyPath<T, Duration?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Duration?>(this,TestBuild::buildModelDuration)

    val testSentencesDuration: KPropertyPath<T, Duration?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                java.time.Duration?>(this,TestBuild::testSentencesDuration)

    val nbSentencesInModel: KPropertyPath<T, Int?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.Int?>(this,TestBuild::nbSentencesInModel)

    val nbSentencesTested: KPropertyPath<T, Int?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.Int?>(this,TestBuild::nbSentencesTested)

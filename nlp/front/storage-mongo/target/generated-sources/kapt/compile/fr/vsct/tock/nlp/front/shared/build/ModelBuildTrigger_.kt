...
class ModelBuildTrigger_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val applicationId: KPropertyPath<T, Id<ApplicationDefinition>?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                org.litote.kmongo.Id<fr.vsct.tock.nlp.front.shared.config.ApplicationDefinition>?>(this,ModelBuildTrigger::applicationId)

    val all: KPropertyPath<T, Boolean?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.Boolean?>(this,ModelBuildTrigger::all)

    val onlyIfModelNotExists: KPropertyPath<T, Boolean?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.Boolean?>(this,ModelBuildTrigger::onlyIfModelNotExists)

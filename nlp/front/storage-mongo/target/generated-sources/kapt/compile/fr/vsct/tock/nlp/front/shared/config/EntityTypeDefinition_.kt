...
class EntityTypeDefinition_<T>(previous: KPropertyPath<T, *>?, property: KProperty1<*,
    ...
    val name_: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.String?>(this,EntityTypeDefinition::name)

    val description: KPropertyPath<T, String?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                kotlin.String?>(this,EntityTypeDefinition::description)
    ...
    val _id: KPropertyPath<T, Id<EntityTypeDefinition>?>
        get() = org.litote.kmongo.property.KPropertyPath<T,
                org.litote.kmongo.Id<fr.vsct.tock.nlp.front.shared.config.EntityTypeDefinition>?>(this,EntityTypeDefinition::_id)
    ...
    companion object {
        ...
        val SubEntities: EntityDefinition_Col<EntityTypeDefinition>
            get() =
                    EntityDefinition_Col<EntityTypeDefinition>(null,EntityTypeDefinition::subEntities)
        val PredefinedValues: PredefinedValue_Col<EntityTypeDefinition>
            get() =
                    PredefinedValue_Col<EntityTypeDefinition>(null,EntityTypeDefinition::predefinedValues)
